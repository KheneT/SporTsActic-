 ...
 * @author Saavedra
 */
public class frmFormularioRutinas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtObjetivo = new javax.swing.JComboBox<>();
        ...
        txtDias.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "4", "5", "6" }));

        jComboBox2.setBackground(new java.awt.Color(204, 204, 204));
        jComboBox2.setForeground(new java.awt.Color(0, 0, 0));
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hombre", "Mujer" }));

        txtObjetivo.setBackground(new java.awt.Color(204, 204, 204));
        txtObjetivo.setForeground(new java.awt.Color(0, 0, 0));
        txtObjetivo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Aumentar la fuerza", "Mejorar la resistencia", "Aumento de masa muscular" }));

        jButton2.setBackground(new java.awt.Color(0, 102, 0));
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setText("Generar Rutina de Entrenamiento");
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtDias, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtObjetivo, 0, 1, Short.MAX_VALUE)))
                    .addGroup(jPanel13Layout.createSequentialGroup()
                        .addGap(155, 155, 155)
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        String objetivo = txtObjetivo.getSelectedItem().toString().trim();
        int dias = Integer.parseInt(txtDias.getSelectedItem().toString().trim());
            ...
            if (rs.getInt("planEntrenamiento") == 0) {
                if (nombre.length() > 0) {
                    try {
                        ...
                        st1.executeUpdate("UPDATE Usuario set planEntrenamiento= " + 1 + " WHERE persona_fk=" + usuario.id + ";");
                        Statement actualizar = con.createStatement();
                        if (dias == 4 && objetivo.equals("Aumentar la fuerza")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "4f";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                            new frmTorsoPiernaFuerza().setVisible(true);
                            this.dispose();

                        } else if (dias == 5 && objetivo.equals("Aumentar la fuerza")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "5f";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                            ...
                            this.dispose();
                        } else if (dias == 6 && objetivo.equals("Aumentar la fuerza")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "6f";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                            ...
                            this.dispose();
                        } else if (dias == 4 && objetivo.equals("Mejorar la resistencia")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "4r";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                            ...
                            this.dispose();
                        } else if (dias == 5 && objetivo.equals("Mejorar la resistencia")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "5r";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                            ...
                            this.dispose();
                        } else if (dias == 6 && objetivo.equals("Mejorar la resistencia")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "6r";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                            ...
                            this.dispose();
                        } else if (dias == 4 && objetivo.equals("Aumento de masa muscular")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "4m";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                            ...
                            this.dispose();
                        } else if (dias == 5 && objetivo.equals("Aumento de masa muscular")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "5m";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                            ...
                            this.dispose();
                        } else if (dias == 6 && objetivo.equals("Aumento de masa muscular")) {
                            JOptionPane.showMessageDialog(null, "La rutina acorde a tus objetivos fue asignada correctamente", "Asignacion exitosa", JOptionPane.INFORMATION_MESSAGE);
                            rutina = "6m";
                            actualizar.executeUpdate("UPDATE Usuario set rutinaCode='" + rutina + "' where persona_fk=" + usuario.id + ";");
                    ...
                    JOptionPane.showMessageDialog(null, "Por favor rellene todos los campos", "Advertencia", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(null, "Usted ya tiene una Rutina de Entrenamiento asignada", "Aviso", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmFormularioRutinas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> txtObjetivo;
