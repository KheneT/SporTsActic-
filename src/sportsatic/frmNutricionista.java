...
public class frmNutricionista extends javax.swing.JFrame {
    ...
    public frmNutricionista() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM NutricionistaP");
            ...
            while (rs.next()) {
                ...
                modelo.addRow(new Object[]{rs.getInt("idNutricionista"), rs2.getString("Nombre"), experiencia, rs.getInt("clientes"), rs.getInt("calificacion"), Math.round(rs.getFloat("precio_mes"))});
  ...
  private void jPanel9MouseClicked(java.awt.event.MouseEvent evt) {                                     
    ...
    private void initComponents() {
        ...
        jLabel21.setText("NUTRICIONISTAS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (saldo >= valor) {
            ...
            try {
                ...
                rs0 = st00.executeQuery("SELECT * FROM  nutricionista_usuario where usuario_fk=" + rs0.getInt("idUsuario") + ";");

                //AQUI SE HACE LA COMPROBACION QUE EL USUARIO NO HAYA RESERVADO UN ENTRENADOR
                if (rs0.next()) {

                    JOptionPane.showMessageDialog(null, "Usted ya tiene un nutricionista personalizado", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    ...
                    try {
                        ...
                        st7.executeUpdate("INSERT INTO nutricionista_usuario (nutricionistaP_fk,usuario_fk) values (" + codigo + "," + rs1.getInt("idUsuario") + ");");
                    ...
                    try {
                        ...
                        if (confirmar == 0) {
                            ...
                            ResultSet rs = st6.executeQuery("SELECT * FROM NutricionistaP");
                            rs.next();
                            ...
                            int k = st5.executeUpdate("UPDATE NutricionistaP set Clientes=" + clientes + " where idNutricionista=" + codigo2 + ";");
                            //actualizamos el saldo 
                            Saldo();

                            JOptionPane.showMessageDialog(null, "Nutricionista reservado con exito", "Reserva Exitosa!", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void actualizarIngresos(Integer idEntrenador, float valor) {
        ...
        try {
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM NutricionistaP where idNutricionista=" + idEntrenador + ";");
            rs.next();
            float ganancia = rs.getFloat("ingresos") + valor;
            System.out.println(ganancia);
            System.out.println(idEntrenador);
            System.out.println(valor);
            String sql = "UPDATE NutricionistaP set ingresos=? where idNutricionista=? ;";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNutricionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmNutricionista().setVisible(true);
