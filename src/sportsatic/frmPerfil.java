...
public class frmPerfil extends javax.swing.JFrame {
    ...
    public frmPerfil() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM Persona where Usuario='" + usuario.user + "';");
        ...
        try {
            ...
            ResultSet rs = st2.executeQuery("SELECT saldo FROM usuario where persona_fk=" + usuario.id + ";");
    ...
    private void initComponents() {
        ...
        jPanel3.add(txtSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 90, 20));
        ...
        boxGenero.setBackground(new java.awt.Color(204, 204, 204));
        boxGenero.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            int confirmar = st.executeUpdate("UPDATE Persona SET Nombre='" + nombre + "',Apellido='" + apellido + "',Genero='" + genero + "',Correo='" + correo + "',Edad=" + edad + ",Contraseña='" + contraseña + "' WHERE Usuario='" + username + "';");

            if (confirmar == 0) {
                JOptionPane.showMessageDialog(null, "El usuario no se pudo actualizar", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        int x = JOptionPane.showConfirmDialog(null, "¿Realmente desea eliminar la cuenta?");
        if (x == 0) {
            Connection con = Conexion.getConexion();

            try {
                Statement st = con.createStatement();
                int confirmacion = st.executeUpdate("DELETE FROM Persona where Usuario='" + username + "';");
                if (confirmacion == 0) {
