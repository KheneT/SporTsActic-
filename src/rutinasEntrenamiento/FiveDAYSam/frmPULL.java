 ...
 * @author Saavedra
 */
public class frmPULL extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPULL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
